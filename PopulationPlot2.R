...
rome <- ggplot(dat.rome) + 
  ...
  annotate("text", label="Empire established", x = 3, y =2900000, color="orange1", angle=270, hjust=0) +
  annotate("rect", xmin = 359, xmax = 410, ymin = -Inf, ymax = Inf, fill = "orange1", alpha = 0.6) +
  annotate("text", label="Imperial capitol moves/sacking of Rome", x = 430, y =2900000, color="orange1", angle=270, hjust=0) +
