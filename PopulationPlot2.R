...
london <- ggplot(dat.london) + 
  ...
  #theme_dark() +
  scale_x_continuous(name="Year", limits=c(-1000, 2020), breaks=c(-1000,-500,0,500,1000,1500,2000),labels=c("1000 BC", "500 BC", "BC/AD","AD 500", "AD 1000","AD 1500","AD 2000")) +
  scale_y_log10(name="Log Population", limits=c(100,10000000), breaks=c(100,1000,10000,100000,1000000,10000000), labels=c(10^2,10^3,10000,100000,1000000,10000000))



ggarrange(rome, london, ncol = 1, nrow = 2, labels=c('Rome','London'))