...
rome <- ggplot(dat.rome) + 
  ...
  annotate("text", label="Founding of Rome", x = -730, y =3900000, color="orange1", angle=270, hjust=0) +
  annotate("rect", xmin = -509, xmax = -503, ymin = -Inf, ymax = Inf, fill = "orange1", alpha = 0.6) +
  annotate("text", label="Roman Republic", x = -483, y =3900000, color="orange1", angle=270, hjust=0) +
  annotate("rect", xmin = -27, xmax = -23, ymin = -Inf, ymax = Inf, fill = "orange1", alpha = 0.6) +
  annotate("text", label="Roman Empire", x = 3, y =3900000, color="orange1", angle=270, hjust=0) +
  annotate("rect", xmin = 359, xmax = 410, ymin = -Inf, ymax = Inf, fill = "orange1", alpha = 0.6) +
  annotate("text", label="Capitol moves/sacking of Rome", x = 430, y =3900000, color="orange1", angle=270, hjust=0) +
  annotate("rect", xmin = 1380, xmax = 1600, ymin = -Inf, ymax = Inf, fill = "orange1", alpha = 0.6) +
  annotate("text", label="Church funded reconstruction", x = 1620, y =3900000, color="orange1", angle=270, hjust=0) +
  annotate("rect", xmin = 1861, xmax = 1880, ymin = -Inf, ymax = Inf, fill = "orange1", alpha = 0.6) +
  annotate("text", label="Italian reunification", x = 1900, y =3900000, color="orange1", angle=270, hjust=0) 
...
byzantium <- ggplot(dat.byz1) + 
  ...
  annotate("rect", xmin = -657, xmax = -647, ymin = -Inf, ymax = Inf, fill = "orange1", alpha = 0.6) +
  annotate("text", label="Founding of Byzantium", x = -627, y =695000, color="orange1", angle=270, hjust=0) +
  annotate("rect", xmin = 330, xmax = 340, ymin = -Inf, ymax = Inf, fill = "orange1", alpha = 0.6) +
  annotate("text", label="Founding of Constantinope", x = 360, y =695000, color="orange1", angle=270, hjust=0) +
  annotate("rect", xmin = 1453, xmax = 1463, ymin = -Inf, ymax = Inf, fill = "orange1", alpha = 0.6) +
  annotate("text", label="Capitol Ottoman Empire", x = 1483, y =695000, color="orange1", angle=270, hjust=0) 
...
byzantium2 <- ggplot(dat.byz2) + 
  ...
  annotate("rect", xmin = 1919, xmax = 1923, ymin = -Inf, ymax = Inf, fill = "orange1", alpha = 0.6) +
  annotate("text", label="Turkish War of Independance", x = 1943, y =9900000, color="orange1", angle=270, hjust=0) 
...
mex <- ggplot(dat.mex) +
  ...
  annotate("rect", xmin = 1324, xmax = 1334, ymin = -Inf, ymax = Inf, fill = "orange1", alpha = 0.6) +
  annotate("text", label="Founding of Tenochitlan", x = 1354, y =240000, color="orange1", angle=270, hjust=0) +
  annotate("rect", xmin = 1521, xmax = 1531, ymin = -Inf, ymax = Inf, fill = "orange1", alpha = 0.6) +
  annotate("text", label="Spanish conquest", x = 1551, y =240000, color="orange1", angle=270, hjust=0) 
...
mex2 <- ggplot(dat.mex) +
  ...
  annotate("rect", xmin = 1821, xmax = 1831, ymin = -Inf, ymax = Inf, fill = "orange1", alpha = 0.6) +
  annotate("text", label="Mexican Independance", x = 1851, y =24000000, color="orange1", angle=270, hjust=0) 
